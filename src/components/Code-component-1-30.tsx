...
const products = [
  ...
  },
  {
    ...
    price: 25,
    image: "https://images.unsplash.com/photo-1675809421636-a44c4484925d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXIlMjBzcG9pbGVyJTIwd2luZyUyMGF1dG9tb3RpdmUlMjBtb2RpZmljYXRpb258ZW58MXx8fHwxNzU3NjA3NzIzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    seller: {
      name: "CarbonCraft",
      avatar: "https://images.unsplash.com/photo-1586447751596-6c2050a0d335?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhdXRvbW90aXZlJTIwbWVjaGFuaWMlMjBlbmdpbmVlciUyMHBvcnRyYWl0fGVufDF8fHx8MTc1NzYwNzcyNHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product) => (
            <Card key={product.id} className="bg-card border-border hover:border-primary/50 transition-colors group cursor-pointer">
