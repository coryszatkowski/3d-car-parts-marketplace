            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm mb-4">Start creating and selling your 3D car parts</p>
                  <Button>
                    <Edit3 className="h-4 w-4 mr-2" />
                    Create Product
                  </Button>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm mb-4">Browse parts and save your favorites</p>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Get notified about new parts and updates</p>
                  </div>
